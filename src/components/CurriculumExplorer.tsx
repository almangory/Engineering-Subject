...
> = {
  // ====================
  // الباب الأول: الرسم الهندسي
  // ====================
  "intro-projection": {
    labId: "projection",
    labName: "محاكي مفهوم ونظرية الإسقاط",
    description: "محاكاة أشعة النظر العمودية الساقطة من الجسم إلى مستوى الإسقاط لتكوين مسقط دقيق ثنائي الأبعاد.",
  },
  "ortho-principles": {
    labId: "projection",
    labName: "محاكي حالات الإسقاط المتعامد",
    description: "دوران مستقيم أو سطح لمعاينة طول المسقط الفعلي؛ مسقط الموازي بطوله الحقيقي والعمودي كنقطة أو خط مستقيم.",
  },
  "three-planes": {
    labId: "projection",
    labName: "محاكي المساقط الثلاثة ونظام الزاوية الأولى",
    description: "ترتيب وتوزيع المساقط (الرأسي، الأفقي، والجانبي الأيسر) وفق نظام الزاوية الأولى المعتمد في المنهج السوداني.",
  },
  "isometric-oblique": {
    labId: "projection",
    labName: "محاكي المنظور الأيزومتري والمائل (الكافاليير)",
    description: "مقارنة المنظور الأيزومتري بزاوية 30° بالمنظور المائل بزاوية 45° مع تصغير خطوط العمق لنصف قيمتها.",
  },
  "dim-1-1": {
    labId: "projection",
    labName: "محاكي وضع الأبعاد والمواصفات الفنية",
    description: "فحص المسافة القياسية بين خط البعد وحواف الجسم (8-10 مم) واستخدام رموز الأقطار (ق) والأقواس (نق).",
  },
  "sketch-1-2": {
    labId: "projection",
    labName: "محاكي التكريك والرسم باليد الحرة",
    description: "التدريب على رسم الخطوط الأفقية من اليسار لليمين، والعمودية من أعلى لأسفل، وتكوين الدوائر كروكياً بالمحاور.",
  },

  // ====================
  // الباب الثاني: الهندسة الميكانيكية
  // ====================
  "metals-intro": {
    labId: "engine",
    labName: "محاكي خواص واختبارات الفلزات",
    description: "إجراء الفحص الميكانيكي بالمغناطيس، واختبار الشرر، وتحديد الكثافة النسبية للحديد والصلب والنحاس والألومنيوم.",
  },
  "iron-production": {
    labId: "engine",
    labName: "محاكي صهر الفرن اللافح والكيوبولا",
    description: "التحكم في شحنة فحم الكوك والحجر الجيري ودرجة الحرارة (1300°م) لبثق حديد زهر التماسيح وفصل الخبث.",
  },
  "steel-rolling": {
    labId: "engine",
    labName: "محاكي دحرجة ودرفلة الصلب",
    description: "تمرير الصلب بين درافيل دوارة على الساخن (1300°م) أو البارد لإنتاج رقائق صاج ناعمة ذات سمك متجانس بدقة عالية.",
  },
  "non-ferrous-alloys": {
    labId: "engine",
    labName: "محاكي سبائك النحاس والبرنز والبيضاء",
    description: "خلط نسب النحاس بالخارصين لإنتاج النحاس الأصفر (للصنابير) وبالقصدير للبرنز، وتجهيز السبيكة البيضاء لكراسي التحميل.",
  },
  "engines-cycles": {
    labId: "engine",
    labName: "محاكي دورة أوتو رباعية الأشواط",
    description: "تشغيل محرك الاحتراق الداخلي رباعي الأشواط ورصد حركة المكبس والصمامات في أشواط السحب، الضغط، القدرة، والطرد.",
  },
  "car-engine-systems": {
    labId: "engine",
    labName: "محاكي أنظمة محرك السيارة الأربعة",
    description: "معايرة نسبة خلط الكاربريتر (1 : 15 بالوزن)، ضبط حرارة الرديتر (190-230°F)، مضخة الزيت، وتوقيت شرارة الاسبراتير.",
  },

  // ====================
  // الباب الثالث: الهندسة الكهربائية
  // ====================
  "electrical-units": {
    labId: "capacitor",
    labName: "محاكي شحنات كولوم والقوة الكهروستاتيكية",
    description: "حساب القوة الميكانيكية المتبادلة بين شحنتين بالكولوم طبقاً لقانون كولوم والسماحية العازلة للوسط الفاصل.",
  },
  "capacitors": {
    labId: "capacitor",
    labName: "محاكي المكثف اللوحي المتوازي وسعته",
    description: "تغيير مساحة اللوحين والمسافة ونوع المادة العازلة لحساب السعة بالفاراد والشحنة والطاقة المخزنة بالجول.",
  },
  "electromagnetism-induction": {
    labId: "capacitor",
    labName: "محاكي حث فارادي الكهرومغناطيسي",
    description: "تحريك المغناطيس داخل وخارج الملف ورصد انحراف مؤشر الجلفانومتر لتوليد قوة دافعة كهربائية حثية.",
  },
  "self-inductance": {
    labId: "capacitor",
    labName: "محاكي ظاهرة الحث الذاتي وقانون لينز",
    description: "رصد ق.د.ك المعارضة لتغير التيار في الملف والمحاثة الذاتية بالهنري ورؤية تأخر توهج المصباح وتوليد الشرارة.",
  },
  "semiconductors-doping": {
    labId: "capacitor",
    labName: "محاكي تشويب بلورات أشباه الموصلات",
    description: "تشويب شبكة السيليكون رباعية التكافؤ بالزرنيخ الخماسي لبلورة n-type أو بالبورون الثلاثي لبلورة p-type.",
  },

  // ====================
  // الباب الرابع: الهندسة المدنية والبيئة
  // ====================
  "structures-trusses": {
    labId: "elasticity",
    labName: "محاكي الجملونات وتحليل قوى الأعضاء",
    description: "تطبيق الأحمال على جملونات الأسقف والجسور ورصد أعضاء الشد (أزرق) وأعضاء الضغط (أحمر) لحساب الاستقرار الإنشائي.",
  },
  "arches-foundations": {
    labId: "elasticity",
    labName: "محاكي الأقواس وتصميم الأساسات",
    description: "تحليل ثقل القوس المنحني واختبار القواعد السطحية (منفصلة ولبشة) والعميقة (الخوازيق) تحت ثقل الطوابق وطبقات التربة.",
  },
  "stress-strain-hooke": {
    labId: "elasticity",
    labName: "محاكي منحنى الإجهاد والانفعال وقانون هوك",
    description: "اختبار شد العينات المعدنية وحساب الإجهاد والانفعال ومعامل المرونة (ي) وتحديد حد المرونة والخضوع والكسر.",
  },
  "fluid-mechanics-viscosity": {
    labId: "elasticity",
    labName: "محاكي لزوجة الموائع وقانون نيوتن",
    description: "إسقاط كرات معدنية في الزيت والماء والعسل ومقارنة زمن الهبوط وحساب معامل اللزوجة الديناميكية ومقاومة القص.",
  },
  "environmental-pollution": {
    labId: "elasticity",
    labName: "محاكي تلوث الهواء والأمطار الحمضية",
    description: "محاكاة تصاعد غازات SOx و NOx لتكوين الأمطار الحمضية، واختبار تصنيف أمراض المياه البيئية الأربعة.",
  },
};
